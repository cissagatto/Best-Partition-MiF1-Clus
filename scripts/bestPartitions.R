...
bestPart <- function(ds, dataset_name, number_folds, folderResults){
  ...
  setwd(diretorios$folderResultsDataset)
  write.csv(allMacroF1Part[-2], paste(dataset_name, "-All-MicroF1-Partitions.csv", sep=""), row.names = FALSE)
  ...
  setwd(diretorios$folderResultsDataset)
  write.csv(result3, paste(dataset_name, "-best-microF1-partitions.csv", sep=""), row.names = FALSE)
